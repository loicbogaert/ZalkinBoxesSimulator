        ...
        <div  className="choicesContainer">
            <Fragment>
                <div className="infos_container">
                    ...
                    <a className="infos_container__link" href="#/simulator"><button className="button buttonChoice">I made my choice</button></a>
                </div>
